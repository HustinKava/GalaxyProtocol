            ...
            <Container maxWidth="sm" className="mobileCenter">
              <div className="bannerTitleContainer universityText">
                <img
                  src={UniversityIcon}
                  alt="University icon"
                  className="universityIcon"
                />
                <span className="banUniversityHeader banUniversityHeader--1">
                  Galaxy
                </span>
              ...
              <span className="banDesc banDesc--1">
                ...
                relax, interact with other people from our community and above
                all to show off your creative talent. Oh and earn tokens.
              </span>
              <div className="bannerButtonContainer">
                <a href="#/galaxyUniversity">
                  <button className="ban-button ban-button--learn btn-desktop">
                    Learn more
                  </button>
                </a>
              </div>
