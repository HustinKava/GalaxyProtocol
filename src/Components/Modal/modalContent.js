export const modalContent = {
  ...
  termsModal: (
    <div className='content-align-left'>
      <b>Terms of Service & Conditions</b>
      <br /><br />
      <b>Interpretation</b>
      <br />
      ...
      <b>Country</b>
      <br />
      refers to: Toronto, Canada.
      <br /><br />
      <b>Company</b>
      <br />
      (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Cryptonite Technologies Ltd,  5700 Yonge Street, Suite 200, Toronto ON, M2M 4K2.
      <br /><br />
      <b>Device</b>
      <br />
      ...
      <br />
      (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and Cryptonite Technologies regarding the use of the Service.
      ...
      <b>Website</b>
      <br />
      refers to Galaxy Protocol, accessible from https://galaxyprotocol.io
      <br /><br />
      <b>You</b>
      <br />
      ...
      <br />
      Our Privacy Policy - https://galaxyprotocol.io/privacy. Please refer to our Privacy Policy on how we collect, use and disclose information about our users.
      <br />
      Our Cookie Policy - https://galaxyprotocol.io/privacy, which sets out information about the cookies on our site.
      <br /><br />
      ...
      You understand and acknowledge that you are responsible for any User Contributions you submit or contribute, and you, not the Company, have full responsibility for such content, including its legality, reliability, accuracy, and appropriateness. We are not responsible or liable to any third party for the content or accuracy of any User Contributions posted by you or any other user of the Website. By posting User Contributions, you hereby release Cryptonite Technologies Ltd. and its agents and employees from any claims that such use, as authorized above, violates any of your rights and you understand that you will not be entitled to any additional compensation for any use of your User Contributions.
      <br /><br />
      You agree not to post, send or create User Contributions that are in compliance with the following (Content Standards):
      <br /><br />
      In any way that breaches any applicable local, national or international law or regulation.
      <br />
      In any way that is unlawful or fraudulent or has any unlawful or fraudulent purpose or effect.
      <br />
      Defamatory of any person, obscene, offensive, hateful or inflammatory, bully, insult, intimidate or humiliate, promote sexually explicit material, include child sexual abuse material and promote violence.
      <br />
      ...
      <br />
      When we consider that a breach of the User Contribution has occurred, we may take such action as we deem appropriate.
      <br />
      If you wish to complain about content uploaded by other users, please contact us at admin@galaxyprotocol.io
      <br />
      By posting User Contributions, you hereby release Cryptonite Technologies and its agents and employees from any claims that such use, as authorized above, violates any of your rights and you understand that you will not be entitled to any additional compensation for any use of your User Contributions.
      <br /><br />
      <b>Website Use</b>
      <br />
      ...
      <br />
      To send, knowingly receive, upload, download, use or re-use any material which does not comply with our User Contributions.
      <br />
      ...
      You also agree:
      <br />
      Not to reproduce, duplicate, copy or re-sell any part of our Website in contravention of the provisions of our Terms of Service.
      <br />
      ...
      <br />
      We are the owner or the licensee of all intellectual property rights in our Website, and in all the material published on it. Those works are protected by copyright laws and treaties around the world. All such rights are reserved.
      <br /><br />
      ...
      <br /><br />
      <b>UPLOADING CONTENT TO OUR WEBSITE</b>&nbsp;
      Whenever you make use of a feature that allows you to upload content to our Website, or to make contact with other users of our Website, you must comply with the standards set out in User Contributions.
      <br /><br />
      ...
      <b>Arbitration</b>
      <br />
      If you have any dispute about the Service, you first agree to reach an agreement with the Company using your best endeavors to resolve.
      <br /><br />
      ...
      <br />
      Remove or refuse to post any User Contributions for any violations of these Terms of Use.
      <br />
      ...
      &nbsp;<b>YOU WAIVE AND HOLD HARMLESS THE COMPANY AND ITS AFFILIATES FROM ANY CLAIMS RESULTING FROM ANY ACTION TAKEN BY THE COMPANY, DURING, OR TAKEN AS A CONSEQUENCE OF, INVESTIGATIONS BY EITHER THE COMPANY OR LAW ENFORCEMENT AUTHORITIES</b>.
      <br />
  ...
  privacyModal: (
    <div className='content-align-left'>
      <b>Privacy Policy & Cookies Policy</b>
      <br />
      <b>Updated March 23, 2021</b>
      <br /><br />
      We, Cryptonite Technologies Ltd. (galaxyprotocol.io), are committed to protecting any data that we collect concerning you. By using our services you agree to the use of the data that we collect in accordance with this Privacy Policy.
      <br /><br />
      ...
      <b>Cookies</b>
      <br />
      Your Internet browser has the in-built facility for storing small text files - "cookies" - that hold information which allows a website to recognize your account. We use cookies to save your preferences and login information, and provide personalized functionality. You can reject cookies by changing your browser settings, but be aware that this will disable some of the functionality on the Galaxy Protocol website. More information about cookies can be found at: 
      <br />
      <a href='https://en.wikipedia.org/wiki/HTTP_cookie' target="_blank" rel="noopener noreferrer">https://en.wikipedia.org/wiki/HTTP_cookie</a>
    </div>
  ),
  buyBackModal: (
    <>
    {/* <div className='content-align-left'> */}
      <span className='buyback-header'>BuyBack walk through</span>
      <br /><br />
      Devs Deploy Galaxia Contract
      <br />
      Devs Deploy BuyBack Contrat
      <br />
      Devs Mint Galaxia equal to diluted SafeGgit statualaxy Marketcap +20%
      <br />
      ...
      <br />
      User SafeGalaxy is sent to Buyback Contract, Devs will also take part in this exchange (There are no fees for this transaction)
      <br />
