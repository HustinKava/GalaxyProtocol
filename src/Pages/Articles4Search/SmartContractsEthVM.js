...
import SmartContractSlice from '../../Assets/articlesSlice/smart-contract-slice.png';

export const SmartContractsEthVM = {
  // id acts as route -> '/articles/:id'
  id: 'SmartContractsandtheEthereumVirtualMachine',
  title: 'Smart Contracts and the Ethereum Virtual Machine',
  level: 'Advanced',
  heroImage: SmartContractHero,
  imageSlice: SmartContractSlice,
