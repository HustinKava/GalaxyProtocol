import EthVsBtcHero from '../../Assets/articles/eth-vs-btc.png';
import EthVsBtcSlice from '../../Assets/articlesSlice/eth-vs-btc-slice.png';

export const ETHvsBTC = {
  // id acts as route -> '/articles/:id'
  id: 'ETHvsBTC',
  title: 'Ethereum vs Bitcoin blockchain',
  level: 'Beginner',
  heroImage: EthVsBtcHero,
  imageSlice: EthVsBtcSlice,
