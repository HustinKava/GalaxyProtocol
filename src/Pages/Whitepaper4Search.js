...
const Whitepaper = () => {
  let content = {
    ...
    body: [
      {
        paraContent: [
          'In the immediate aftermath of the 2008 financial crisis, people began to experiment with the idea of whether clearly defined, emotionless technology in a trustless environment could govern finance.',
      ...
      },
      {
        paraContent: [
          ...
          <ul className="bullet-points">
            ...
            <li>
              Internal advertising and promotion through the GalaxyProtocol
              community
            </li>
          ...
          <ul className="bullet-points">
            ...
            <li>
              If soft cap is reached within the presale's time frame, funds are
              automatically sent to GalaxySwap and trading pair is established
              in order to avoid rug pull
            </li>
          </ul>,
        ],
      },
      ...
      },
      {
        ...
        paraContent: [
          <ul className="bullet-points">
            ...
            <li>Nebula Launchpad Launch - August 15, 2021</li>
          </ul>,
        ],
      },
      {
